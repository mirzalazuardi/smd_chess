...
- [x] **1.2** Generate PWA icons from `public/logo-percasi.jpg` (1557×1600)
...
- [x] **1.4** Configure PWA in `next.config.mjs`
...
- [x] **2.1** Fix pairing TV view responsive grid
...
- [x] **2.2** Fix jadwal page mobile overflow
...
- [x] **2.3** Fix klasemen table mobile scroll
...
- [x] **3.1** Fix admin tournament table mobile scroll
